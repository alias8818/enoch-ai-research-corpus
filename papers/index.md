...
| [Adapter-Projected GaLore 192-Step Decoupled-Refresh MMLU Eval](adapter-projected-galore-192-step-decoupled-refresh-mmlu-eval/paper.md) | `enoch-paper-0099` | yes | yes | 0 | false | 20 |
| [Adapter-Projected GaLore 192-Step Decoupled-Refresh MMLU Eval](adapter-projected-galore-192-step-decoupled-refresh-mmlu-eval-9a62dd9416/paper.md) | `enoch-paper-0385` | yes | yes | 2 | false | 20 |
| [Adaptive Boundary Colorization Gate](adaptive-boundary-colorization-gate/paper.md) | `enoch-paper-0089` | yes | yes | 0 | false | 20 |
| [Adaptive Boundary Colorization Gate](adaptive-boundary-colorization-gate-3b59f6774f/paper.md) | `enoch-paper-0463` | yes | yes | 2 | false | 20 |
...
| [Adaptive Budget-Aware LIM Reserve Sampler](adaptive-budget-aware-lim-reserve-sampler-2ddbf25384/paper.md) | `enoch-paper-0466` | yes | yes | 2 | false | 20 |
| [Adaptive Claim-First Top-K Router](adaptive-claim-first-top-k-router/paper.md) | `enoch-paper-0003` | yes | yes | 0 | false | 7 |
| [Adaptive Claim-First Top-K Router](adaptive-claim-first-top-k-router-d0dc50a98c/paper.md) | `enoch-paper-0484` | yes | yes | 2 | false | 7 |
...
| [Adaptive Evidence Packer RAG Integration](adaptive-evidence-packer-rag-integration-2a4e77b31a/paper.md) | `enoch-paper-0453` | yes | yes | 2 | false | 13 |
...
| [Adaptive Prefix Splitter Inference Integration](adaptive-prefix-splitter-inference-integration-6d161ce689/paper.md) | `enoch-paper-0448` | yes | yes | 2 | false | 3 |
| [Adversarial Channel Router](adversarial-channel-router/paper.md) | `enoch-paper-0044` | yes | yes | 0 | false | 6 |
| [Adversarial Channel Router](adversarial-channel-router-e74eea0518/paper.md) | `enoch-paper-0495` | yes | yes | 2 | false | 6 |
| [Agent App Store With Repro Sandboxes](agent-app-store-with-repro-sandboxes/paper.md) | `enoch-paper-0043` | yes | yes | 0 | false | 1 |
| [Agent App Store With Repro Sandboxes](agent-app-store-with-repro-sandboxes-5f40c40e86/paper.md) | `enoch-paper-0494` | yes | yes | 2 | false | 1 |
| [Agent Budget Parliament](agent-budget-parliament/paper.md) | `enoch-paper-0166` | yes | yes | 0 | false | 0 |
| [Agent Identity Rotation](agent-identity-rotation/paper.md) | `enoch-paper-0042` | yes | yes | 0 | false | 7 |
| [Agent Identity Rotation](agent-identity-rotation-85bfb941f9/paper.md) | `enoch-paper-0489` | yes | yes | 2 | false | 7 |
...
| [Answer-Shape Prompt Planner](answer-shape-prompt-planner-ba167182f1/paper.md) | `enoch-paper-0431` | yes | yes | 2 | false | 10 |
...
| [Applicability-Gated Abstention Calibration Policy](applicability-gated-abstention-calibration-policy-52021fb1e7/paper.md) | `enoch-paper-0467` | yes | yes | 2 | false | 15 |
...
| [Aretē: Hierarchical Multi-Virtue Reward Architecture for RL](aret-hierarchical-multi-virtue-reward-architecture-for-rl-cc711c3474/paper.md) | `enoch-paper-0377` | yes | yes | 2 | false | 20 |
...
| [Attention-Loss Shadow Estimator](attention-loss-shadow-estimator-448f1cdd17/paper.md) | `enoch-paper-0420` | yes | yes | 2 | false | 20 |
...
| [Batched Reader QETS Mixed-Domain Scaling Validation](batched-reader-qets-mixed-domain-scaling-validation-1e48547905/paper.md) | `enoch-paper-0464` | yes | yes | 2 | false | 14 |
...
| [Batched vLLM Speculation-Cost Governor Integration](batched-vllm-speculation-cost-governor-integration-6f2deec9e5/paper.md) | `enoch-paper-0445` | yes | yes | 2 | false | 20 |
| [Benchmark Explorer Agent](benchmark-explorer-agent/paper.md) | `enoch-paper-0133` | yes | yes | 0 | false | 0 |
| [Benchmark Health Ledger](benchmark-health-ledger/paper.md) | `enoch-paper-0046` | yes | yes | 0 | false | 4 |
| [Benchmark Health Ledger](benchmark-health-ledger-e3e46df81f/paper.md) | `enoch-paper-0490` | yes | yes | 2 | false | 4 |
| [Benchmark Qwen3 Non-Uniform REAP Manual-FP8 Scoring](benchmark-qwen3-non-uniform-reap-manual-fp8-scoring/paper.md) | `enoch-paper-0017` | yes | yes | 0 | false | 18 |
| [Benchmark Qwen3 Non-Uniform REAP Manual-FP8 Scoring](benchmark-qwen3-non-uniform-reap-manual-fp8-scoring-3b0b701050/paper.md) | `enoch-paper-0391` | yes | yes | 2 | false | 18 |
| [Benchmark Qwen3 Non-Uniform REAP Manual-FP8 Scoring](benchmark-qwen3-non-uniform-reap-manual-fp8-scoring-433ea5b89a/paper.md) | `enoch-paper-0392` | yes | yes | 2 | false | 18 |
...
| [Bonsai-Up Logprob-Margin Safeguard Deployment Benchmark](bonsai-up-logprob-margin-safeguard-deployment-benchmark-2310f99ce2/paper.md) | `enoch-paper-0401` | yes | yes | 2 | false | 9 |
...
| [Byte-Memory Pointer Decoder for Fragile Spans](byte-memory-pointer-decoder-for-fragile-spans-9e45f48f18/paper.md) | `enoch-paper-0403` | yes | yes | 2 | false | 7 |
...
| [Cache Churn Alarm vLLM Adapter Benchmark](cache-churn-alarm-vllm-adapter-benchmark-228d4519a8/paper.md) | `enoch-paper-0442` | yes | yes | 2 | false | 20 |
| [Cache Quantization Awareness Training](cache-quantization-awareness-training/paper.md) | `enoch-paper-0278` | yes | yes | 0 | false | 0 |
| [Cache Reentry Production Endpoint Validation](cache-reentry-production-endpoint-validation/paper.md) | `enoch-paper-0013` | yes | yes | 0 | false | 9 |
| [Cache Reentry Production Endpoint Validation](cache-reentry-production-endpoint-validation-52f1745344/paper.md) | `enoch-paper-0404` | yes | yes | 2 | false | 9 |
...
| [Capability Retention Sentinel Live Baseline Adapter Run](capability-retention-sentinel-live-baseline-adapter-run/paper.md) | `enoch-paper-0027` | yes | yes | 0 | false | 0 |
| [Capability Retention Sentinel Live Baseline Adapter Run](capability-retention-sentinel-live-baseline-adapter-run-22ad70e0c1/paper.md) | `enoch-paper-0386` | yes | yes | 2 | false | 0 |
| [Capable Planner Segment-Firewall Validation](capable-planner-segment-firewall-validation/paper.md) | `enoch-paper-0093` | yes | yes | 0 | false | 4 |
| [Capable Planner Segment-Firewall Validation](capable-planner-segment-firewall-validation-3de5a48185/paper.md) | `enoch-paper-0396` | yes | yes | 3 | false | 4 |
...
| [Chain-of-Density Evidence Pack](chain-of-density-evidence-pack/paper.md) | `enoch-paper-0116` | yes | yes | 0 | false | 3 |
| [Chain-of-Density Evidence Pack](chain-of-density-evidence-pack-c783196b5f/paper.md) | `enoch-paper-0409` | yes | yes | 2 | false | 3 |
| [Cheap Factual Correction After Local Sycophancy Rejection](cheap-factual-correction-after-local-sycophancy-rejection/paper.md) | `enoch-paper-0105` | yes | yes | 0 | false | 1 |
| [Cheap Factual Correction After Local Sycophancy Rejection](cheap-factual-correction-after-local-sycophancy-rejection-1886329759/paper.md) | `enoch-paper-0440` | yes | yes | 2 | false | 1 |
| [Chunk-Margin Pruner](chunk-margin-pruner/paper.md) | `enoch-paper-0032` | yes | yes | 0 | false | 20 |
| [Chunk-Margin Pruner](chunk-margin-pruner-2b55848aba/paper.md) | `enoch-paper-0407` | yes | yes | 2 | false | 20 |
...
| [Citation-Focused Section Ordering](citation-focused-section-ordering-fb43bdffef/paper.md) | `enoch-paper-0482` | yes | yes | 2 | false | 9 |
...
| [Citation Locator Metadata Extraction Intervention Benchmark](citation-locator-metadata-extraction-intervention-benchmark-a982006d78/paper.md) | `enoch-paper-0443` | yes | yes | 2 | false | 6 |
...
| [Commit-Level Critic](commit-level-critic-8b2442c412/paper.md) | `enoch-paper-0488` | yes | yes | 2 | false | 20 |
...
| [Compress-Then-Answer Benchmark](compress-then-answer-benchmark-c53b7c2a1f/paper.md) | `enoch-paper-0426` | yes | yes | 2 | false | 14 |
...
| [Contention-Aware Single-Medium Backend Broker Benchmark](contention-aware-single-medium-backend-broker-benchmark/paper.md) | `enoch-paper-0057` | yes | yes | 0 | false | 20 |
| [Contention-Aware Single-Medium Backend Broker Benchmark](contention-aware-single-medium-backend-broker-benchmark-475e083a27/paper.md) | `enoch-paper-0471` | yes | yes | 2 | false | 20 |
...
| [Context Overflow Real LLM Reader Validation](context-overflow-real-llm-reader-validation-fb8ac0a46b/paper.md) | `enoch-paper-0441` | yes | yes | 2 | false | 13 |
...
| [Context Rehydration Multi-Model Validation](context-rehydration-multi-model-validation-db1eeb1f24/paper.md) | `enoch-paper-0424` | yes | yes | 2 | false | 18 |
...
| [Context Reuse Clusterer Local Serving Harness](context-reuse-clusterer-local-serving-harness-3293a9b6dd/paper.md) | `enoch-paper-0435` | yes | yes | 2 | false | 15 |
...
| [Counterexample Bank Targeted Mini-SFT Validation](counterexample-bank-targeted-mini-sft-validation/paper.md) | `enoch-paper-0118` | yes | yes | 0 | false | 3 |
| [Counterexample Bank Targeted Mini-SFT Validation](counterexample-bank-targeted-mini-sft-validation-e001666b78/paper.md) | `enoch-paper-0437` | yes | yes | 2 | false | 3 |
...
| [CPU-Offload Stress Harness Real-Server Scaleup](cpu-offload-stress-harness-real-server-scaleup/paper.md) | `enoch-paper-0119` | yes | yes | 0 | false | 20 |
| [CPU-Offload Stress Harness Real-Server Scaleup](cpu-offload-stress-harness-real-server-scaleup-7ac6d3d13e/paper.md) | `enoch-paper-0438` | yes | yes | 2 | false | 20 |
| [CUAD Cross-Model Legal Answer Quality Replication](cuad-cross-model-legal-answer-quality-replication/paper.md) | `enoch-paper-0063` | yes | yes | 0 | false | 10 |
| [CUAD Cross-Model Legal Answer Quality Replication](cuad-cross-model-legal-answer-quality-replication-964eda1287/paper.md) | `enoch-paper-0465` | yes | yes | 2 | false | 10 |
| [CUAD Dense Retriever Productionization with Cached Vector Index](cuad-dense-retriever-productionization-with-cached-vector-index/paper.md) | `enoch-paper-0054` | yes | yes | 0 | false | 10 |
| [CUAD Dense Retriever Productionization with Cached Vector Index](cuad-dense-retriever-productionization-with-cached-vector-index-c25709dd7d/paper.md) | `enoch-paper-0479` | yes | yes | 2 | false | 10 |
...
| [Deadline-Guarded Speculation Live Serving Validation](deadline-guarded-speculation-live-serving-validation-be3d57eec2/paper.md) | `enoch-paper-0454` | yes | yes | 2 | false | 20 |
...
| [Demo Position Lottery](demo-position-lottery-dc4b968515/paper.md) | `enoch-paper-0418` | yes | yes | 2 | false | 4 |
...
| [Developer Workflow Persona Drift Benchmark Against FileGram](developer-workflow-persona-drift-benchmark-against-filegram/paper.md) | `enoch-paper-0005` | yes | yes | 0 | false | 6 |
| [Developer Workflow Persona Drift Benchmark Against FileGram](developer-workflow-persona-drift-benchmark-against-filegram-4e6de530c8/paper.md) | `enoch-paper-0486` | yes | yes | 2 | false | 6 |
| [DFlash Code-Generation Quality Guard](dflash-code-generation-quality-guard/paper.md) | `enoch-paper-0006` | yes | yes | 0 | false | 20 |
| [DFlash Code-Generation Quality Guard](dflash-code-generation-quality-guard-d435059a51/paper.md) | `enoch-paper-0382` | yes | yes | 2 | false | 20 |
| [DFlash GB10 Transformers Smoke](dflash-gb10-transformers-smoke/paper.md) | `enoch-paper-0038` | yes | yes | 0 | false | 7 |
| [DFlash GB10 Transformers Smoke](dflash-gb10-transformers-smoke-0b34db2889/paper.md) | `enoch-paper-0381` | yes | yes | 2 | false | 7 |
| [DFlash vLLM/SGLang Throughput Shootout](dflash-vllm-sglang-throughput-shootout/paper.md) | `enoch-paper-0001` | yes | yes | 0 | false | 20 |
| [DFlash vLLM/SGLang Throughput Shootout](dflash-vllm-sglang-throughput-shootout-acada17226/paper.md) | `enoch-paper-0387` | yes | yes | 2 | false | 20 |
| [DFlash vs Existing Spec-Dec Baseline Harness](dflash-vs-existing-spec-dec-baseline-harness/paper.md) | `enoch-paper-0020` | yes | yes | 0 | false | 20 |
| [DFlash vs Existing Spec-Dec Baseline Harness](dflash-vs-existing-spec-dec-baseline-harness-caedfff9e6/paper.md) | `enoch-paper-0384` | yes | yes | 2 | false | 20 |
...
| [Difficulty-Aware Mask Bank - Successor Branch](difficulty-aware-mask-bank---successor-branch-652045ba64/paper.md) | `enoch-paper-0380` | yes | yes | 2 | false | 20 |
...
| [Document-Field Importance LLM Generation Validation](document-field-importance-llm-generation-validation-bb6c85041c/paper.md) | `enoch-paper-0413` | yes | yes | 2 | false | 1 |
...
| [Draft-Value Router](draft-value-router-8b7bb3b644/paper.md) | `enoch-paper-0398` | yes | yes | 2 | false | 14 |
| [Dual-Trace Memory Encoder](dual-trace-memory-encoder/paper.md) | `enoch-paper-0103` | yes | yes | 0 | false | 3 |
| [Dual-Trace Memory Encoder](dual-trace-memory-encoder-6bd25ff090/paper.md) | `enoch-paper-0402` | yes | yes | 2 | false | 3 |
...
| [Engine-Level Prefix Cache Cohort Scheduler](engine-level-prefix-cache-cohort-scheduler/paper.md) | `enoch-paper-0035` | yes | yes | 0 | false | 20 |
| [Engine-Level Prefix Cache Cohort Scheduler](engine-level-prefix-cache-cohort-scheduler-810eeb05f0/paper.md) | `enoch-paper-0408` | yes | yes | 2 | false | 20 |
...
| [Entity-Neighborhood Windower](entity-neighborhood-windower/paper.md) | `enoch-paper-0009` | yes | yes | 0 | false | 3 |
| [Entity-Neighborhood Windower](entity-neighborhood-windower-739d77e465/paper.md) | `enoch-paper-0423` | yes | yes | 2 | false | 3 |
| [Evidence-Bound Proof Synthesizer for Tool Ledger](evidence-bound-proof-synthesizer-for-tool-ledger/paper.md) | `enoch-paper-0098` | yes | yes | 0 | false | 10 |
| [Evidence-Bound Proof Synthesizer for Tool Ledger](evidence-bound-proof-synthesizer-for-tool-ledger-4bb53c9047/paper.md) | `enoch-paper-0433` | yes | yes | 2 | false | 10 |
| [Evidence-First Answerability Cutoff Integration Benchmark](evidence-first-answerability-cutoff-integration-benchmark/paper.md) | `enoch-paper-0056` | yes | yes | 0 | false | 20 |
| [Evidence-First Answerability Cutoff Integration Benchmark](evidence-first-answerability-cutoff-integration-benchmark-87cb13bc5f/paper.md) | `enoch-paper-0472` | yes | yes | 2 | false | 20 |
| [Evidence-First Context Ladder Prompt Layout Ablation](evidence-first-context-ladder-prompt-layout-ablation/paper.md) | `enoch-paper-0070` | yes | yes | 0 | false | 15 |
| [Evidence-First Context Ladder Prompt Layout Ablation](evidence-first-context-ladder-prompt-layout-ablation-b1c2c65887/paper.md) | `enoch-paper-0446` | yes | yes | 2 | false | 15 |
...
| [Fieldwise Recall Probe Real-Trace Multi-Model Validation](fieldwise-recall-probe-real-trace-multi-model-validation/paper.md) | `enoch-paper-0085` | yes | yes | 0 | false | 17 |
| [Fieldwise Recall Probe Real-Trace Multi-Model Validation](fieldwise-recall-probe-real-trace-multi-model-validation-3cbaf8e0d7/paper.md) | `enoch-paper-0459` | yes | yes | 2 | false | 17 |
...
| [FlashAttention-4 Kernel Pipelining for sm_121 (FA4-sm121)](flashattention-4-kernel-pipelining-for-sm_121-fa4-sm121-e7971f7338/paper.md) | `enoch-paper-0376` | yes | yes | 2 | false | 20 |
...
| [Forced Contrastive Self-Audit Extraction Trace Benchmark](forced-contrastive-self-audit-extraction-trace-benchmark-6a93b3b661/paper.md) | `enoch-paper-0395` | yes | yes | 2 | false | 4 |
...
| [GB10 Joule Router Live Calibration Adapter](gb10-joule-router-live-calibration-adapter-de3ab2c063/paper.md) | `enoch-paper-0434` | yes | yes | 2 | false | 10 |
...
| [GB10 Local Server Utility Swap Broker Validation](gb10-local-server-utility-swap-broker-validation-798a9fe509/paper.md) | `enoch-paper-0457` | yes | yes | 2 | false | 20 |
...
| [Home Lab Agent Orchestrator](home-lab-agent-orchestrator-876ea845f9/paper.md) | `enoch-paper-0491` | yes | yes | 2 | false | 8 |
| [Hot-Cold Tensor Paging](hot-cold-tensor-paging/paper.md) | `enoch-paper-0039` | yes | yes | 0 | false | 20 |
| [Hot-Cold Tensor Paging](hot-cold-tensor-paging-bc643f18f8/paper.md) | `enoch-paper-0493` | yes | yes | 2 | false | 20 |
...
| [Human-Checked Acceptance Trace Validation](human-checked-acceptance-trace-validation-8e3ceb5519/paper.md) | `enoch-paper-0416` | yes | yes | 2 | false | 7 |
...
| [HumanEval MBPP Counterexample-Harvest Verifier Transfer](humaneval-mbpp-counterexample-harvest-verifier-transfer-2e35d6977f/paper.md) | `enoch-paper-0399` | yes | yes | 2 | false | 4 |
...
| [Intercept-Aware KV Checkpointing for Tool Calls - Successor Branch](intercept-aware-kv-checkpointing-for-tool-calls---successor-branch-a54ccd2781/paper.md) | `enoch-paper-0378` | yes | yes | 2 | false | 20 |
...
| [Junction Adapter Broader RYS Benchmark](junction-adapter-broader-rys-benchmark-4090194b12/paper.md) | `enoch-paper-0393` | yes | yes | 2 | false | 11 |
...
| [KV Eviction Gold Labels](kv-eviction-gold-labels-617a0a21e2/paper.md) | `enoch-paper-0432` | yes | yes | 2 | false | 12 |
...
| [LLM Code Navigation Context-Packer Evaluation](llm-code-navigation-context-packer-evaluation-3a30325780/paper.md) | `enoch-paper-0460` | yes | yes | 2 | false | 5 |
| [LLM Evidence-Survival QA Validation](llm-evidence-survival-qa-validation/paper.md) | `enoch-paper-0053` | yes | yes | 0 | false | 20 |
| [LLM Evidence-Survival QA Validation](llm-evidence-survival-qa-validation-7369a2c25f/paper.md) | `enoch-paper-0475` | yes | yes | 2 | false | 20 |
...
| [Long-Tail Entity Boost Mix](long-tail-entity-boost-mix-593359d822/paper.md) | `enoch-paper-0417` | yes | yes | 2 | false | 20 |
...
| [Memory Pressure Admission Gate Live Serving Validation](memory-pressure-admission-gate-live-serving-validation-c2c4ef0659/paper.md) | `enoch-paper-0430` | yes | yes | 2 | false | 6 |
| [Memory Pressure Replay Logs](memory-pressure-replay-logs/paper.md) | `enoch-paper-0065` | yes | yes | 0 | false | 20 |
| [Memory Pressure Replay Logs](memory-pressure-replay-logs-399667d44a/paper.md) | `enoch-paper-0436` | yes | yes | 2 | false | 20 |
...
| [Multi-Model Real-Span Boundary Corruption Benchmark](multi-model-real-span-boundary-corruption-benchmark-3de4e67099/paper.md) | `enoch-paper-0455` | yes | yes | 2 | false | 6 |
...
| [Near-Miss Tool Call Dataset](near-miss-tool-call-dataset-53189437af/paper.md) | `enoch-paper-0421` | yes | yes | 2 | false | 3 |
| [Network Path Curiosity Agent](network-path-curiosity-agent/paper.md) | `enoch-paper-0132` | yes | yes | 0 | false | 0 |
| [Neural Endpoint Segment Order Sensitivity Validation](neural-endpoint-segment-order-sensitivity-validation/paper.md) | `enoch-paper-0113` | yes | yes | 0 | false | 4 |
| [Neural Endpoint Segment Order Sensitivity Validation](neural-endpoint-segment-order-sensitivity-validation-88fd97a900/paper.md) | `enoch-paper-0425` | yes | yes | 2 | false | 4 |
...
| [Open-Weight Integrity Twin Agent Sweep](open-weight-integrity-twin-agent-sweep-0ccf945b66/paper.md) | `enoch-paper-0427` | yes | yes | 2 | false | 0 |
...
| [OpenAI-Compatible Deployment of Syntax-Preserving RAG Adapter](openai-compatible-deployment-of-syntax-preserving-rag-adapter-f4c3279614/paper.md) | `enoch-paper-0473` | yes | yes | 2 | false | 14 |
...
| [Outcome-Calibrated Real-Trace Safety-Drift Monitor](outcome-calibrated-real-trace-safety-drift-monitor-3ba0f94143/paper.md) | `enoch-paper-0412` | yes | yes | 2 | false | 10 |
...
| [Pair-Adaptive Draft Waste Calibration Benchmark](pair-adaptive-draft-waste-calibration-benchmark-483f4eaba5/paper.md) | `enoch-paper-0406` | yes | yes | 2 | false | 6 |
...
| [Partial-Evidence Audited SFT Recall-Preservation Ablation](partial-evidence-audited-sft-recall-preservation-ablation-6c2fa2a1c9/paper.md) | `enoch-paper-0481` | yes | yes | 2 | false | 20 |
| [Partial-Module RYS](partial-module-rys/paper.md) | `enoch-paper-0100` | yes | yes | 0 | false | 8 |
| [Partial-Module RYS](partial-module-rys-214ec2d410/paper.md) | `enoch-paper-0379` | yes | yes | 2 | false | 8 |
...
| [Precision-Filtered Evidence Anchors for Distractor-Robust QA](precision-filtered-evidence-anchors-for-distractor-robust-qa-f5f7002f1a/paper.md) | `enoch-paper-0452` | yes | yes | 2 | false | 19 |
...
| [Prefix-Equivalence Targeted Normalizer Uplift](prefix-equivalence-targeted-normalizer-uplift-7aac87ee48/paper.md) | `enoch-paper-0419` | yes | yes | 2 | false | 6 |
...
| [Prefix Seeder Serving Adapter Benchmark](prefix-seeder-serving-adapter-benchmark-0dda3ef06c/paper.md) | `enoch-paper-0478` | yes | yes | 2 | false | 20 |
| [Prefix-Share Serving Trace Set](prefix-share-serving-trace-set/paper.md) | `enoch-paper-0071` | yes | yes | 0 | false | 0 |
| [Prefix-Share Serving Trace Set](prefix-share-serving-trace-set-deb949d444/paper.md) | `enoch-paper-0414` | yes | yes | 2 | false | 0 |
...
| [Production End-Task Canonical-First RYS Variant Benchmark](production-end-task-canonical-first-rys-variant-benchmark/paper.md) | `enoch-paper-0018` | yes | yes | 0 | false | 7 |
| [Production End-Task Canonical-First RYS Variant Benchmark](production-end-task-canonical-first-rys-variant-benchmark-0ed3345070/paper.md) | `enoch-paper-0394` | yes | yes | 2 | false | 7 |
...
| [Production RAG KV-Offload Landmark Reliability Scale-Up](production-rag-kv-offload-landmark-reliability-scale-up-25fe5716f0/paper.md) | `enoch-paper-0474` | yes | yes | 2 | false | 0 |
...
| [Production Speculative Decoding Counter Validation](production-speculative-decoding-counter-validation-508a95f82a/paper.md) | `enoch-paper-0458` | yes | yes | 2 | false | 8 |
...
| [Query Budget Contract Local Server Benchmark](query-budget-contract-local-server-benchmark-301a0a4c9e/paper.md) | `enoch-paper-0461` | yes | yes | 2 | false | 20 |
...
| [Real-Corpus Row-ID Citation QA Integration Benchmark](real-corpus-row-id-citation-qa-integration-benchmark-86b43b9fc1/paper.md) | `enoch-paper-0449` | yes | yes | 2 | false | 20 |
...
| [Real-Document Retrieval Compression Teacher Validation](real-document-retrieval-compression-teacher-validation-af518c0527/paper.md) | `enoch-paper-0429` | yes | yes | 2 | false | 5 |
| [Real-Mode Stress Regularization](real-mode-stress-regularization/paper.md) | `enoch-paper-0268` | yes | yes | 0 | false | 0 |
| [Real-Model Negative-Exit Controller on Math and Code Search Traces](real-model-negative-exit-controller-on-math-and-code-search-traces/paper.md) | `enoch-paper-0108` | yes | yes | 0 | false | 18 |
| [Real-Model Negative-Exit Controller on Math and Code Search Traces](real-model-negative-exit-controller-on-math-and-code-search-traces-92c852013c/paper.md) | `enoch-paper-0400` | yes | yes | 2 | false | 18 |
| [Real-RAG Answer-Abstention Boundary Benchmark](real-rag-answer-abstention-boundary-benchmark/paper.md) | `enoch-paper-0068` | yes | yes | 0 | false | 6 |
| [Real-RAG Answer-Abstention Boundary Benchmark](real-rag-answer-abstention-boundary-benchmark-481ae7871e/paper.md) | `enoch-paper-0444` | yes | yes | 2 | false | 6 |
...
| [Real RYS Wall-Clock Throughput for Budget-Pruned Representation Seeding](real-rys-wall-clock-throughput-for-budget-pruned-representation-seeding/paper.md) | `enoch-paper-0025` | yes | yes | 0 | false | 7 |
| [Real RYS Wall-Clock Throughput for Budget-Pruned Representation Seeding](real-rys-wall-clock-throughput-for-budget-pruned-representation-seeding-1264f736d5/paper.md) | `enoch-paper-0389` | yes | yes | 2 | false | 7 |
| [Real-Task Context Compression Pareto Validation](real-task-context-compression-pareto-validation/paper.md) | `enoch-paper-0110` | yes | yes | 0 | false | 8 |
| [Real-Task Context Compression Pareto Validation](real-task-context-compression-pareto-validation-a9db9821a9/paper.md) | `enoch-paper-0410` | yes | yes | 2 | false | 8 |
| [Real Trace Near-Miss Refusal Adapter Validation](real-trace-near-miss-refusal-adapter-validation/paper.md) | `enoch-paper-0107` | yes | yes | 0 | false | 4 |
| [Real Trace Near-Miss Refusal Adapter Validation](real-trace-near-miss-refusal-adapter-validation-9afd0f1d27/paper.md) | `enoch-paper-0397` | yes | yes | 2 | false | 4 |
| [REAP Dynamic Tree Shaping](reap-dynamic-tree-shaping/paper.md) | `enoch-paper-0373` | yes | yes | 0 | false | 0 |
| [REAP Ragged Loader Real-Checkpoint Integration](reap-ragged-loader-real-checkpoint-integration/paper.md) | `enoch-paper-0102` | yes | yes | 0 | false | 2 |
| [REAP Ragged Loader Real-Checkpoint Integration](reap-ragged-loader-real-checkpoint-integration-4a35e4aebb/paper.md) | `enoch-paper-0390` | yes | yes | 2 | false | 2 |
...
| [Reduced-Planner Scratchpad Feedback Real Repo-QA Validation](reduced-planner-scratchpad-feedback-real-repo-qa-validation-8a97fc9598/paper.md) | `enoch-paper-0480` | yes | yes | 2 | false | 18 |
...
| [Rejection-Mode Targeted Abstention Refusal Tuning](rejection-mode-targeted-abstention-refusal-tuning-8c1fd3db27/paper.md) | `enoch-paper-0450` | yes | yes | 2 | false | 20 |
...
| [Residue-Head Teacher Distillation for LBRC](residue-head-teacher-distillation-for-lbrc/paper.md) | `enoch-paper-0059` | yes | yes | 0 | false | 20 |
| [Residue-Head Teacher Distillation for LBRC](residue-head-teacher-distillation-for-lbrc-b9f4fd77ce/paper.md) | `enoch-paper-0469` | yes | yes | 2 | false | 20 |
| [Resource-Bounded Agent Kernel](resource-bounded-agent-kernel/paper.md) | `enoch-paper-0040` | yes | yes | 0 | false | 20 |
| [Resource-Bounded Agent Kernel](resource-bounded-agent-kernel-1127e6ebd4/paper.md) | `enoch-paper-0492` | yes | yes | 2 | false | 20 |
...
| [Retrieval-Aware Evidence Packer Arbitration Benchmark](retrieval-aware-evidence-packer-arbitration-benchmark-c601be3b27/paper.md) | `enoch-paper-0485` | yes | yes | 2 | false | 20 |
...
| [Router-Distilled Triton MLP Full-Model Integration](router-distilled-triton-mlp-full-model-integration-ab4e1a5044/paper.md) | `enoch-paper-0388` | yes | yes | 2 | false | 20 |
...
| [Salience-Backed Candidate Top-1 KV Prefill Packing Benchmark](salience-backed-candidate-top-1-kv-prefill-packing-benchmark/paper.md) | `enoch-paper-0058` | yes | yes | 0 | false | 12 |
| [Salience-Backed Candidate Top-1 KV Prefill Packing Benchmark](salience-backed-candidate-top-1-kv-prefill-packing-benchmark-5576bc3d18/paper.md) | `enoch-paper-0470` | yes | yes | 2 | false | 12 |
...
| [Schema-Drift JSON Corpus](schema-drift-json-corpus-d97a28b051/paper.md) | `enoch-paper-0415` | yes | yes | 2 | false | 0 |
...
| [Semantic Overlap Tax Generative LLM Public RAG Benchmark](semantic-overlap-tax-generative-llm-public-rag-benchmark-3348c5e036/paper.md) | `enoch-paper-0451` | yes | yes | 2 | false | 12 |
...
| [Shared-Prompt Batcher Local-Server Validation](shared-prompt-batcher-local-server-validation-0e58ffd5bd/paper.md) | `enoch-paper-0447` | yes | yes | 2 | false | 15 |
...
| [Short-Train Long-Eval Prompt-Robust Tuning](short-train-long-eval-prompt-robust-tuning-55360a96d1/paper.md) | `enoch-paper-0462` | yes | yes | 2 | false | 20 |
...
| [Small-Model Persona Context Orderer Generation Validation](small-model-persona-context-orderer-generation-validation-5ee3b77220/paper.md) | `enoch-paper-0477` | yes | yes | 2 | false | 6 |
...
| [Structured Noise Injection Suite](structured-noise-injection-suite-e24b2e17ae/paper.md) | `enoch-paper-0428` | yes | yes | 2 | false | 10 |
...
| [Token Rent for Examples](token-rent-for-examples-21bc7b6ced/paper.md) | `enoch-paper-0411` | yes | yes | 2 | false | 20 |
| [Token-Type Importance Labels](token-type-importance-labels/paper.md) | `enoch-paper-0096` | yes | yes | 0 | false | 9 |
| [Token-Type Importance Labels](token-type-importance-labels-9d67810608/paper.md) | `enoch-paper-0439` | yes | yes | 2 | false | 9 |
...
| [Tokenized Tiny-LM Duplicate Ratio Ablation](tokenized-tiny-lm-duplicate-ratio-ablation-e352f99372/paper.md) | `enoch-paper-0456` | yes | yes | 2 | false | 9 |
...
| [UTR Conflict-Update Final-Answer Schema Hardening](utr-conflict-update-final-answer-schema-hardening-ee2ec3df1c/paper.md) | `enoch-paper-0483` | yes | yes | 2 | false | 20 |
...
| [Value-per-Joule Broker Online Canary on GB10 Endpoints](value-per-joule-broker-online-canary-on-gb10-endpoints-7c1e9366d2/paper.md) | `enoch-paper-0405` | yes | yes | 2 | false | 13 |
...
| [Verification Failure Clusters](verification-failure-clusters-ec5ecfde87/paper.md) | `enoch-paper-0422` | yes | yes | 2 | false | 6 |
...
| [vLLM Attention-Sink Retention 3B Continuous-Serving Stress Campaign](vllm-attention-sink-retention-3b-continuous-serving-stress-campaign-e679db6170/paper.md) | `enoch-paper-0468` | yes | yes | 2 | false | 20 |
...
| [Wake-Gate Local Endpoint Harness Integration](wake-gate-local-endpoint-harness-integration-a559f7e6df/paper.md) | `enoch-paper-0383` | yes | yes | 2 | false | 15 |
...
| [Weak-Wikipedia Generative Answer Flattening Pilot](weak-wikipedia-generative-answer-flattening-pilot-a0927e1c3e/paper.md) | `enoch-paper-0476` | yes | yes | 2 | false | 3 |
...
| [Web-State Replay Benchmark for Rewindable Sandboxes](web-state-replay-benchmark-for-rewindable-sandboxes-b07c9b5663/paper.md) | `enoch-paper-0487` | yes | yes | 2 | false | 2 |
